...
extension Date {
    ...
    /// ex: if now is 4/19 at 2:00 pm the valid range is 4/18 12:00 am to 4:18 11:59 pm 
    ///     (with a 1 minute buffer on both sides to account for records in 
    ///     CloudKit that might be created exactly at 12:00 am)
